...
#import "UIDevice+QNetworkMethods.h"
#import "NSString+QNetworkMethods.h"
...
@implementation UIDevice (QNetworkMethods)
...
- (NSString *) QN_macaddressMD5{
    ...
    if (macid.length == 0) {
        NSString *macaddress = [[UIDevice currentDevice] QN_macaddress];
        macid = [macaddress QN_md5];
        if (!macid){
