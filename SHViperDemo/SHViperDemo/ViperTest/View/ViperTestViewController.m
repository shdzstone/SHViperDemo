...
#import "ViperTestViewDataSource.h"
 
@interface ViperTestViewController () <SHViperViewPrivate>
@property (nonatomic, strong) id<ViperTestViewEventHandler> eventHandler;
@property (nonatomic, strong) id<ViperTestViewDataSource> viewDataSource;
@property (nonatomic, assign) BOOL ready;
@end

@implementation ViperTestViewController
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    if (self.ready == NO) {
        ...
        NSAssert([self.eventHandler conformsToProtocol:@protocol(ViperTestViewEventHandler)], nil);
